...
const BaseUrl = "https://uniform.thealchemydripuniforms.com/api/v1/";
// const BaseUrl = "http://192.168.1.72:8080/api/v1/";
...
export const get_city = BaseUrl + "get-city";
export const get_city_category = BaseUrl + "get-city-category";
